...
class TextCommandsCog(commands.Cog): # temp until dynamic stuff is ready   
    ...
    @perms.command_with_perms(min_role="Soaper", name="soapnormal", aliases=["normalsoap", "normal"], help="Displays normal SOAP completion message")
    ...
    @perms.command_with_perms(min_role="Soaper", name="soaplottery", aliases=["lotterysoap","lottery"], help="Displays \"lottery\" SOAP completion message")
    @perms.soap_channels_only()
    @ping_before_mes()
    ...
    @perms.command_with_perms(min_role="Soaper", name="findserial", aliases=["serial", "serialmismatch"], help="Explains how to find a serial number in GM9")
    @perms.soap_channels_only()
    @ping_before_mes()
